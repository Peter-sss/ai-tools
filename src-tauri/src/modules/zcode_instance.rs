...
mod tests {
    ...
    fn process_collection_uses_helper_user_data_dir_after_main_rewrites_argv() {
        let output = r#"
37764     1 ZCode [333]
37767 37764 /Applications/ZCode.app/Contents/Frameworks/ZCode Helper.app/Contents/MacOS/ZCode Helper --type=gpu-process --user-data-dir=/Users/test/.ai-tools/instances/zcode/managed/electron --shared-files
41440     1 ZCode
...
"#;
    ...
    fn pid_resolution_distinguishes_default_and_managed_user_data_dirs() {
        ...
        let managed_root = Path::new("/Users/test/.ai-tools/instances/zcode/managed");
        let entries = vec![
            (
                37764,
